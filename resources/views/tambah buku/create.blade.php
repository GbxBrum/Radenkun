...
<body>
    <div class="registration-container">
        ...
        <form class="registration-form" action="{{url('registpost')}}" method="POST">
            ...
            <div class="form-group">
                <input type="number" class="form-control" name="penerbit" id="penerbit" placeholder="penerbit">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="tex" class="form-control" name="diskon" id="password" placeholder="diskon">
            </div>
            <button type="submit" class="btn btn-primary btn-block registration-btn">Register</button>
        </form>
